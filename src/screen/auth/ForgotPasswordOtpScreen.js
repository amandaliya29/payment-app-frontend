...
const ForgotPasswordOtpScreen = () => {
  ...
  const { verificationId, mobile, selectedBank, isNbfc, isCredit } = route.params || {};
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      navigation.replace('ResetPinSetupScreen', { mobile, token, bank: selectedBank, isNbfc, isCredit });
